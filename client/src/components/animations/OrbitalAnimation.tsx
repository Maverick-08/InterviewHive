...
const OrbitalAnimation = () => {
  return (
    <div className="relative hidden md:flex h-[420px] w-[420px] flex-col items-center justify-center overflow-hidden bg-transparent">
      ...
      {/* Microsoft icon - inner orbit */}
      <div 
        className="absolute flex transform-gpu animate-orbit items-center justify-center rounded-full border size-[40px] border-none bg-transparent"
        style={{
          '--duration': 20,
          '--radius': '80px',
          '--delay': -20
      ...
      {/* VS Code icon - outer orbit */}
      <div 
        className="absolute flex transform-gpu animate-orbit-reverse items-center justify-center rounded-full border size-[50px] border-none bg-transparent"
        style={{
          '--duration': 20,
          '--radius': '180px',
          '--delay': -10
