...
const Question = ({
  ...
  return (
    ...
    >
      <AccordionTrigger className="text-xl px-4">{`Question ${questionNumber}`}</AccordionTrigger>
      <AccordionContent>
        <div className="text-lg flex flex-col gap-4">
          ...
          <div className="px-4 flex flex-col gap-2">
            ...
            <textarea
              ...
              className="bg-[#333333] h-52 w-full resize-none text-neutral-400  px-2 py-1 rounded-md focus:outline-none"
            />
          </div>
    ...
    <span
            onClick={() => deleteQuestion({ questionId, questionIds, setQuestionIds })}
