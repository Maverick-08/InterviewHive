...
const AddCompanyInfo = () => {
  return (
    <Card componentStyle="px-2 sm:px-4 py-4 sm:py-8 rounded-md">
      <div>
        <h3 className="text-xl sm:text-2xl md:text-4xl">Share Interview Experience</h3>
      ...
      <div className="pt-8 flex justify-center items-center">
        <WhiteButton text="Next Section" className="w-full max-w-md sm:max-w-lg text-lg sm:text-xl" />
      </div>
    </Card>
  );
};
