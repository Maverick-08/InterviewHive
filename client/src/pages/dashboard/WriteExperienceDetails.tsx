...
const WriteExperienceDetails = () => {
  ...
  return (
    <Card componentStyle="w-full py-8 bg-[#171717] border-2 border-[#333333] select-none">
      <div>
        {/* title  */}
        ...
        <div className="pt-12 w-full flex justify-center">
          <WhiteButton disabled={roundIds.length == 0} text="Share Interview Experience" className={`w-full max-w-lg text-xl ${roundIds.length > 0 ? 'bg-white' : 'bg-white/50 hover:bg-white/50'}`}/>
        </div>
      </div>
    </Card>
  );
